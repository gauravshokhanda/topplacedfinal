...
const menuItems = [
  { text: "Home", path: "/dashboard/teacher/home", icon: <HomeIcon /> },
  { text: "Dashboard", path: "/dashboard/teacher/dashboard", icon: <DashboardIcon /> },
  { text: "Booking", path: "/dashboard/teacher/booking", icon: <LibraryBooksIcon /> },
    ...
    <Box sx={{ display: "flex" }}>
      ...
      >
        ...
        <Toolbar sx={{ display: "flex", justifyContent: open ? "space-between" : "center", alignItems: "center", p: 2 }}>
          {open && <Typography variant="h6">Teacher Panel</Typography>}
